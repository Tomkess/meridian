...
|---|---|---|---|---|---|---|---|
| FEAT-008 | Capture ideas away from the PC into a global inbox and triage them into the right project | ~ | draft | m | medium | — | 2026-08-18 |
| FEAT-007 | Scope the shared LanceDB index per project so 10+ repos stop clobbering each other | ~ | in-progress | s | high | — | 2026-08-18 |
